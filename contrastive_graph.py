...
def step(model, loader, optimizer, type='train'):
    ...
    for batch in progress_bar:
        ...
        data_anchor = Data(x=batch.x_anchor, edge_index=batch.edge_index_anchor)
        data_pos = Data(x=batch.x_pos, edge_index=batch.edge_index_pos)

        readout_anchor = model.forward_gnn(data_anchor)
        readout_pos = model.forward_gnn(data_pos)

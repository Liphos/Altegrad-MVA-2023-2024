# This script comes from https://github.com/paridhimaheshwari2708/GraphSSL/blob/main/loss.py
...
class infoNCE(nn.Module):
    ...
    def forward(self, embed_anchor, embed_positive):
        ...
        if self.norm:
            ...
            sim_matrix = sim_matrix / torch.einsum(
                "i,j->ij", embed_anchor_abs, embed_positive_abs
            )
